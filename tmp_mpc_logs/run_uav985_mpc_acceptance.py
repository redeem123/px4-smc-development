...
def main():
    ...
    parser.add_argument(
        "--expected-inertia", type=parse_vector, default=(0.04046, 0.03537, 0.05095)
    )
    parser.add_argument(
        "--expected-effectiveness", type=parse_vector, default=(6.978, 6.978, 1.163)
    )
    parser.add_argument("--expected-torque-limit", type=parse_vector, default=(0.20, 0.20, 0.15))
